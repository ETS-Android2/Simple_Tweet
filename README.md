...
Some of the challenges I encountered doing the second part of this Simple Tweet project
was working with the new way in which the user is taken from one activity to the previous
activity. This is demonstrated after the user tweets something they are taken back to their timeline.
...
It was challeging to use the Twitter API for the first time. Also, this is my second
rendition of the project due to the accidental deletion of my original project.
